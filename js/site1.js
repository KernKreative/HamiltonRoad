    ...
    switch(num) {
        ...
        case 0:
            ...
            multiOut.innerHTML = "<div onclick=\"showMulti()\" class=\"col-md-6 dinerpad sideImage\">" +
                    ...
                    "<h3>KING OF PIGS</h3>" +
                    "<p>The name King of the Pigs is translated from Rei dos Leitoes in Portuguese, which actually means King of the Piglets.\n" +
                "In 1992 our Rei dos Leitoes, first opened its doors in London Ontario.</p>" +
                "<div class=\"divWrapper\"><a href=\"http://kingofthepigs.com\">King of Pigs</a></div>" +
                "<div class=\"singleSocial align-middle\"><i class=\"fab fa-facebook-square fa-2x\"></i> <i class=\"fab fa-twitter-square fa-2x\"></i><a href=\"lvl2KOP.php\" class=\"button\">Specialty Dish</a></div></div>";
